...
aws_region = "us-west-1"#boto3.Session().region_name
...
response = client.invoke_endpoint(
        EndpointName='meta-textgeneration-llama-2-7b-f-2024-02-09-01-22-17-332', ContentType="application/json", Body=encoded_payload
    )
...
llm = SagemakerEndpoint(
        endpoint_name='meta-textgeneration-llama-2-7b-f-2024-02-09-01-22-17-332',
...
if menu == "EDA":
    ...
    if st.session_state.clicked[1]:
        ...
        if user_csv is not None:
            ...
            @st.cache_data
            def steps_eda():
                steps_eda = chain.run('What are the steps of EDA')
                return steps_eda
